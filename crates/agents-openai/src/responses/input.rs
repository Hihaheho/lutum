...
/// ```
/// use agents_openai::responses::InputItem;
/// use serde_json::Value;
///
...
/// ```
/// use agents_openai::responses::InputMessage;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
///     r#"{
...
/// ```
/// use agents_openai::responses::MessageRole;
/// use serde_json::Value;
///
...
/// ```
/// use agents_openai::responses::InputContent;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
...
/// ```
/// use agents_openai::responses::InputTextContent;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
///     r#"{ "type": "input_text", "text": "what is in this image?" }"#,
...
/// ```
/// use agents_openai::responses::OutputTextContent;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
///     r#"{
...
/// ```
/// use agents_openai::responses::RefusalContent;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
...
/// ```
/// use agents_openai::responses::FunctionCallItem;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
///     r#"{
...
/// ```
/// use agents_openai::responses::FunctionCallOutputItem;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
///     r#"{
...
/// ```
/// use agents_openai::responses::ReasoningItem;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
///     r#"{
...
/// ```
/// use agents_openai::responses::SummaryText;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
