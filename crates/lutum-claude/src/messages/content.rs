...
///
/// ```
/// use lutum_claude::messages::content::{
...
///
/// ```
/// use lutum_claude::messages::content::{ClaudeContentBlock, ToolUseBlock};
/// use lutum_protocol::conversation::{ToolCallId, ToolName};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
...
///
/// ```
/// use lutum_claude::messages::content::ToolUseBlock;
/// use lutum_protocol::conversation::{ToolCallId, ToolName};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
...
///
/// ```
/// use lutum_claude::messages::content::ToolResultBlock;
/// use lutum_protocol::conversation::ToolCallId;
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
