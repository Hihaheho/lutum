...
///
/// ```
/// use lutum_claude::messages::response::{
...
/// };
/// use lutum_claude::messages::content::ClaudeRole;
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "message": {
...
/// };
/// use lutum_claude::messages::content::{ClaudeRole, TextBlock};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "id": "msg_123",
...
///
/// ```
/// use lutum_claude::messages::response::{ContentBlockStartEvent, SseContentBlock};
/// use lutum_claude::messages::content::TextBlock;
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "index": 0,
...
///
/// ```
/// use lutum_claude::messages::content::ThinkingBlock;
/// use lutum_claude::messages::response::SseContentBlock;
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "type": "thinking",
...
///
/// ```
/// use lutum_claude::messages::response::{ContentBlockDeltaEvent, SseContentDelta};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "index": 0,
...
///
/// ```
/// use lutum_claude::messages::response::SseContentDelta;
///
/// let json = serde_json::from_str::<serde_json::Value>(
...
///
/// ```
/// use lutum_claude::messages::response::ContentBlockStopEvent;
///
...
///
/// ```
/// use lutum_claude::messages::response::{MessageDelta, MessageDeltaEvent, MessageDeltaUsage};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "delta": {"stop_reason": "end_turn", "stop_sequence": null},
...
///
/// ```
/// use lutum_claude::messages::response::MessageDelta;
///
/// let json = serde_json::from_str::<serde_json::Value>(
...
///
/// ```
/// use lutum_claude::messages::response::MessageDeltaUsage;
///
/// let json = serde_json::from_str::<serde_json::Value>(
...
///
/// ```
/// use lutum_claude::messages::response::MessageStopEvent;
///
...
///
/// ```
/// use lutum_claude::messages::response::PingEvent;
///
/// let json = serde_json::from_str::<serde_json::Value>("{}").unwrap();
/// let value = PingEvent {};
///
...
///
/// ```
/// use lutum_claude::messages::response::{ErrorEvent, StreamError};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "error": {
...
///
/// ```
/// use lutum_claude::messages::response::StreamError;
///
/// let json = serde_json::from_str::<serde_json::Value>(
...
///
/// ```
/// use lutum_claude::messages::response::MessageType;
///
