...
/// ```
/// use lutum_openai::responses::ResponsesRequest;
...
/// ```
/// use lutum_openai::responses::ResponsesReasoningConfig;
/// use serde_json::Value;
///
...
/// ```
/// use lutum_openai::responses::ResponsesTextConfig;
/// use serde_json::Value;
///
...
/// ```
/// use lutum_openai::responses::TextFormat;
/// use serde_json::Value;
///
...
/// ```
/// use lutum_openai::responses::ReasoningEffort;
/// use serde_json::Value;
///
