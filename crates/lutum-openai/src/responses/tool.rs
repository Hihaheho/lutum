...
/// ```
/// use lutum_openai::responses::OpenAiTool;
/// use serde_json::Value;
///
...
/// ```
/// use lutum_openai::responses::OpenAiToolKind;
/// use serde_json::Value;
///
...
/// ```
/// use lutum_openai::responses::FunctionToolChoice;
/// use serde_json::Value;
///
/// let json = serde_json::from_str::<Value>(
...
/// ```
/// use lutum_openai::responses::ToolChoice;
/// use serde_json::Value;
///
