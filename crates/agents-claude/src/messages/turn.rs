...
///
/// ```
/// use agents_claude::messages::turn::{ClaudeCommittedTurn, ClaudeTurnItem};
/// use agents_protocol::{
///     budget::Usage,
///     conversation::{RawJson, ToolCallId, ToolName},
///     llm::FinishReason,
...
///
/// ```
/// use agents_claude::messages::turn::ClaudeTurnItem;
/// use agents_protocol::conversation::{RawJson, ToolCallId, ToolName};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "type": "tool_call",
