...
///
/// ```
/// use agents_claude::messages::request::SystemBlock;
///
/// let json = serde_json::from_str::<serde_json::Value>(
...
///
/// ```
/// use agents_claude::messages::request::{ThinkingConfig, ThinkingKind};
///
/// let json = serde_json::from_str::<serde_json::Value>(
...
///
/// ```
/// use agents_claude::messages::request::ThinkingKind;
///
...
///
/// ```
/// use agents_claude::messages::request::{OutputConfig, OutputFormat};
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "format": {
...
///
/// ```
/// use agents_claude::messages::request::OutputFormat;
///
/// let json = serde_json::from_str::<serde_json::Value>(
///     r#"{
///         "type": "json_schema",
